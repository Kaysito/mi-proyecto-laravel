...
<div class="bg-[var(--surface-2)] rounded-xl border border-[var(--surface-4)] shadow-card p-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <div>
            ...
            <p class="text-sm text-[var(--text-3)] mt-1">Crea y edita los roles de seguridad del sistema.</p>
        </div>
        <button class="flex items-center gap-2 bg-neon-dark hover:bg-neon text-white font-medium py-2 px-5 rounded-lg transition-all duration-300 shadow-neon-sm hover:shadow-neon-md border border-neon-border">
            <i class="fas fa-plus text-sm"></i> <span>Agregar Perfil</span>
        </button>
    </div>
    ...
    <div class="mb-6 flex space-x-3">
        <div class="relative w-full sm:w-1/3">
            ...
            <input type="text" placeholder="Buscar perfil..." class="w-full pl-10 pr-4 py-2.5 bg-[var(--surface-3)] border border-[var(--surface-4)] text-[var(--text-1)] placeholder-[var(--text-3)] rounded-lg focus:outline-none focus:border-[var(--neon-border)] focus:shadow-[0_0_0_3px_rgba(255,23,68,0.1)] transition-all text-sm">
        </div>
    </div>
    ...
    <div class="overflow-x-auto rounded-lg border border-[var(--surface-4)]">
        <table class="min-w-full text-left text-sm whitespace-nowrap">
            <thead class="bg-[var(--surface-3)] border-b border-[var(--surface-4)]">
                <tr>
                    <th class="py-3 px-5 text-[10px] font-mono tracking-widest text-[var(--text-3)] uppercase">Nombre del Perfil</th>
                    <th class="py-3 px-5 text-[10px] font-mono tracking-widest text-[var(--text-3)] uppercase">Nivel de Acceso</th>
            ...
            <tbody class="divide-y divide-[var(--surface-4)]">
                <tr class="hover:bg-[var(--surface-3)] transition-colors duration-150 group">
                    <td class="py-3 px-5 font-medium text-[var(--text-1)]">Super Administrador</td>
                    <td class="py-3 px-5">
                        <span class="inline-flex items-center px-2.5 py-1 rounded-md text-xs font-medium bg-purple-500/10 text-purple-400 border border-purple-500/20">Administrador Total</span>
                    </td>
    ...
    <div class="mt-5 flex flex-col sm:flex-row justify-between items-center text-sm gap-4">
        <span class="text-[var(--text-3)]">Mostrando <span class="text-[var(--text-1)] font-medium">1</span> a <span class="text-[var(--text-1)] font-medium">5</span> de <span class="text-[var(--text-1)] font-medium">12</span> registros</span>
